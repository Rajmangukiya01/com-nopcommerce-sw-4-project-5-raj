...
public class ElectronicsPage extends Utility {
    ...
    public void changeTheQuantity() {
        ...
        sendTextToElements(changeQuantity, "2");
    }
    ...
    public void mandatoryFields() {
        ...
        sendTextToElements(lastName, "smith");
        selectByVisibleTextFromDropDown(day, "2");
        selectByVisibleTextFromDropDown(month, "May");
        selectByVisibleTextFromDropDown(year, "1996");
        sendTextToElements(email, "smith199@gmail.com");
        sendTextToElements(password, "test@100");
        sendTextToElements(confirmPassword, "test@100");
    }
    ...
    public void fillDeliveryAddressFields() {
        ...
        sendTextToElements(postCode, "A2 1BA");
        sendTextToElements(phoneNumber, "07234998765");
    }
    ...
    public void fillCardDetails() {
        sendTextToElements(cardholderName, "Smith leach");
        sendTextToElements(cardNumber, "4222222222222");
        selectByVisibleTextFromDropDown(expireMonth, "04");
        selectByVisibleTextFromDropDown(expireYear, "2026");
        sendTextToElements(cardCode, "643");
    }
